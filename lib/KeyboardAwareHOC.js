...
function KeyboardAwareHOC(
  ...
  return class
    ...
    static defaultProps = {
      ...
      translucentStatusbar: hocOptions.translucentStatusbar
    }
              ...
              UIManager.measureInWindow(
                ...
                (x: number, y: number, width: number, height: number) => {
                  ...
                  if (Platform.OS === 'ios') {
                    ...
                    // height part
                    // When app uses translucent statusbar, system will not scroll the app
                    // so this section has to be ignored
                    if (!this.props.translucentStatusbar && (textInputBottomPosition > keyboardPosition)) {
